...
東京の2000年1月～2021年9月における気象データを気象庁のサイトからダウンロードしたものです．  
https://www.data.jma.go.jp/gmd/risk/obsdl/index.php

天候ラベルは以下の基準で独自に付与してあります．
- 元々のデータセットで昼間の天気が
  - 「快晴」であるもの ⇒「晴」
  - 「曇」であるもの ⇒「曇」
  - 「大雨」「雨時々曇」「雨一時曇」「雨のち時々曇」のいずれかであるもの ⇒「雨」
  - それ以外 ⇒ 無視
- 上記のラベル付けの結果，データ数は全部で2260に．

以上のデータは，学習セットとテストセットにランダム分割した上で保存されています．
...
価格帯ラベル（「20: 価格帯」）は 0, 1, 2, 3 の4種類で，値が大きいほど高価格帯を示します．
