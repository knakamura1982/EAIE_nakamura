...
その上で，数字を a,b,c,d,e,f,g,h,i,j,k,l,m,n,o の順で並べた文字列が環境状態コードです．
...
| 0 | 0 | 0 |
-------------
であり，これを順に並べた 040200300005000 がこの状態を表す環境状態コードとなります．
...
| 0 | 1 | 1 |
-------------
と表現され，これを順に並べた 211011011511011 が環境状態コードとなります．
```
